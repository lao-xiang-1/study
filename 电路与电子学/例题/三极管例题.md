...
**2. 静态工作点计算：**
首先判断是否可以使用近似计算方法: (发射级电阻乘以$(1+\beta)$的原因[晶体管内部的阻抗变换原理](../晶体管内部的阻抗变换原理.md))
...
*$R_{ib}$的计算参考[晶体管内部的阻抗变换原理](../晶体管内部的阻抗变换原理.md)*
...
*   输出电压：$\dot{U}_o = - \beta \dot{I}_b (R_c \parallel R_L)$
	- *$\beta \dot{I}_b$从地流向集电极，也就是说$u_o$的正极电压小于0，所以加负号*
	- 有负号$\to$反相
